...
app.innerHTML = `
  <div class="page">
    <header class="site-header">
      <h1 id="hero-title">Rube-Goldberg CSS Machine</h1>
      <p class="lede">
        A pure CSS homage to the classic looping contraption—drawn with layered gradients,
        container queries, and synchronised keyframes that keep the cue ball moving forever.
      </p>
      <div class="header-actions">
        <a
          class="ghost-link"
          href="https://github.com/dor-j/Rube-Goldberg-CSS-Machine"
          target="_blank"
    ...
    <main class="site-main" id="machine" aria-labelledby="hero-title">
